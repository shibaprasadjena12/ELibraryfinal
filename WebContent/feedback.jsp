...
<%
	try
	{
		...
		PreparedStatement ps=cn.prepareStatement("select * from contactus");
		ResultSet rs=ps.executeQuery();
		if(rs.next())
		{
%>
		<center>
		<h1>FEEDBACK MESSAGES</h1><hr>
			<table border="1" width="95%">
			<tr bgcolor='#ff8000'><th style='text-align:center'>Name</th><th style='text-align:center'>Email</th><th style='text-align:center'>Query</th></tr>
			<tr bgcolor='#ffe6e6'>
				<td style='text-align:center'><%=rs.getString(1) %></td>
				<td style='text-align:center'><a href="feedbackmail.jsp?name=<%=rs.getString(2)%>"><%=rs.getString(2) %></a></td>
...
<%
		...
		{
			out.println("<center><font color='red' size='5'>No Feedback is available...</font></center>");
		}
	}catch(Exception ee)
		{
	ee.printStackTrace();
