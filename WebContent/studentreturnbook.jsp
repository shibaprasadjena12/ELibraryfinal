...
<%
	...
	try
	{
		...
		PreparedStatement ps=cn.prepareStatement("select * from issuetable where sname=?");
		ps.setString(1, name);
...
%>
			<center>
			<h1>RETURN BOOK</h1><hr>
			<table border="1" width="95%">
				<tr bgcolor='#ff8000'><th style='text-align:center'>Student Name</th><th style='text-align:center'>Roll</th><th style='text-align:center'>Book Name</th><th style='text-align:center'>Book ID</th> <th style='text-align:center'>Semester</th> <th style='text-align:center'>Issue Date</th> <th style='text-align:center'>Return Date</th></tr>
				<tr bgcolor='#ffe6e6'>
					...
					<td style='text-align:center' bgcolor="white"> <a href="studentreturnrequest.jsp?id=<%=rs.getString(4)%>" ><input type="button" value="Return"></a></td>
				</tr>	
