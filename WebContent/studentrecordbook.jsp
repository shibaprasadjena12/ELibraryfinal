...
<%
	...
	try
	{
		...
		PreparedStatement ps=cn.prepareStatement("select * from report where sname=?");
		ps.setString(1, name);
...
%>
			<center>
			<h1>STUDENT REPORT</h1><hr><hr>
			<table border="1" width="95%">
				<tr bgcolor='#ff8000'><th style='text-align:center'>Student Name</th><th style='text-align:center'>Roll</th><th style='text-align:center'>Book Name</th><th style='text-align:center'>Book ID</th> <th style='text-align:center'>Semester</th> <th style='text-align:center'>Issue Date</th> <th style='text-align:center'>Return Date</th><th style='text-align:center'>Tentative Date</th><th style='text-align:center'>Fine</th></tr>
				<tr bgcolor='#ffe6e6'>
