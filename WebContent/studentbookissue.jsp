...
%>
			...
			<center>
			<h1>BOOK LIST</h1><hr><hr>
			<table border="1" width="95%"><tr bgcolor='#ff8000'><th style='text-align:center'>Book ID</th><th style='text-align:center'>Book Name</th><th style='text-align:center'>Publisher</th><th style='text-align:center'>Semester</th><th style='text-align:center'>Price</th><th style='text-align:center'>Availability</th></tr>
			<tr bgcolor='#ffe6e6'>
				...
				<td style='text-align:center' bgcolor="white"> <a href="studentissueaction.jsp?id=<%=rs.getString(1)%>" ><input type="button" value="Issue Book"></a></td>
			</tr>
...
%>
				...
				<tr bgcolor='#ffe6e6'>
					...
					<td style='text-align:center'><%=rs.getDouble(5) %></td>
					<td style='text-align:center'><%=rs.getString(6) %></td>
					<td style='text-align:center'> <a href="studentissueaction.jsp?id=<%=rs.getString(1)%>" ><input type="button" value="Issue Book"></a></td>
				</tr>
...
<%
		...
		{
			out.println("<center><font color='red' size='5'>No Search result found...</font></center>");
		}
	}catch(Exception e)
		{
			e.printStackTrace();
