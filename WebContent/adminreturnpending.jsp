...
<%
	...
	try
	{
		...
		PreparedStatement ps=cn.prepareStatement("select * from pendingreturn");
		ResultSet rs=ps.executeQuery();
		if(rs.next())
		{
%>
		<center>
		<h1>PENDING RETURNS</h1><hr><hr>
			...
			<tr bgcolor='#ffe6e6'>
				...
				<td style='text-align:center' bgcolor='white'> <a href="adminreturnaprove.jsp?roll=<%=rs.getString(2)%>" ><input type="button" value="Approve"></a></td>
			</tr>	
